...
var _reveal_on_scroll = __webpack_require__(4);

var _reveal_on_scroll2 = _interopRequireDefault(_reveal_on_scroll);

var _sticky_header = __webpack_require__(5);
...
var MobileMenu = function () {
	function MobileMenu() {
		...
		this.site_header = (0, _jquery2.default)('.site-header');
		this.menu_icon = (0, _jquery2.default)('.site-header__menu-icon');
		this.menu_content = (0, _jquery2.default)('.site-header__menu-content');
		this.events();
	}
...
var StickyHeader = function () {
	function StickyHeader() {
		...
		this.lazy_images = (0, _jquery2.default)('.lazy-load');
		this.site_header = (0, _jquery2.default)('.site-header');
		this.hero_target = (0, _jquery2.default)('.large-hero__title');
		this.header_waypoint();
		this.page_sections = (0, _jquery2.default)('.page-section');
		this.header_links = (0, _jquery2.default)('.primary-nav a');
	...
	_createClass(StickyHeader, [{
		key: 'refresh_waypoint',
		value: function refresh_waypoint() {
		...
		key: 'header_waypoint',
		value: function header_waypoint() {
			var this_obj = this;
			new Waypoint({
		...
		key: 'page_sections_waypoint',
		value: function page_sections_waypoint() {
			var this_obj = this;
...
var Modal = function () {
	function Modal() {
		...
		this.open_modal_button = (0, _jquery2.default)('.open-modal');
		this.modal = (0, _jquery2.default)('.modal');
		this.close_modal_button = (0, _jquery2.default)('.modal__close');
		this.modal_events();
	}

	_createClass(Modal, [{
		key: 'modal_events',
		value: function modal_events() {
			...
			// pushes any key
			(0, _jquery2.default)(document).keydown(this.key_press_handler.bind(this));
		}
	}, {
